...
mongoose
  .connect(
    process.env.MONGO_URI ||
      "mongodb+srv://daniel:Daniel2209.@cluster0.pmdr2xe.mongodb.net/athena_brand",
  )
...
const athenaProducts = [
  // HOMBRE
  {
    ...
    description:
      "Sudadera con capucha de algodón premium. Diseño minimalista con logo bordado. Perfecto para el streetwear urbano.",
    price: 89000,
    discountPrice: 71200,
    ...
    images: [
      {
        url: "https://res.cloudinary.com/tu-cloud/image/upload/v1234567890/products/hoodie-black-1.jpg",
        isPrimary: true,
        alt: "Hoodie Athena Negro",
      },
      {
        url: "https://res.cloudinary.com/tu-cloud/image/upload/v1234567890/products/hoodie-black-2.jpg",
        alt: "Hoodie Athena Negro - Detalle",
      },
    ],
    sizes: [
      { size: "S", stock: 15 },
...

  {
    ...
    description:
      "Camiseta básica de algodón 100% con logo de Athena Brand. Corte regular, perfecta para el día a día.",
    price: 45000,
    discountPrice: 36000,
    category: "hombre",
...

  {
    ...
    description:
      "Jean de corte slim con lavado moderno. Confección premium con detalles únicos de la marca.",
    price: 120000,
    category: "hombre",
  ...
  // MUJER
  {
    ...
    description:
      "Top corto de algodón suave con logo bordado. Ideal para combinar con jeans o shorts.",
    price: 38000,
    discountPrice: 30400,
    category: "mujer",
    subcategory: "camisetas",
...

  {
    ...
    description:
      "Sudadera oversize de máxima comodidad. Diseño contemporáneo con acabados premium.",
    price: 95000,
    category: "hoodies-sacos",
    subcategory: "sudaderas",
    images: [
  ...
  // DEPORTIVOS
  {
    ...
    description:
      "Conjunto deportivo de alto rendimiento. Tela que absorbe la humedad y permite libertad de movimiento.",
    price: 110000,
    discountPrice: 88000,
    category: "deportivos",
...

  {
    ...
    description:
      "Mallas deportivas de compresión media con cintura alta. Perfectas para yoga, gym y running.",
    price: 65000,
    category: "deportivos",
    subcategory: "pantalones",
    images: [
  ...
  // CHAQUETAS
  {
    ...
    description:
      "Chaqueta cortavientos urbana con capucha removible. Resistente al agua y perfecta para el clima bogotano.",
    price: 150000,
  ...
  const additionalProducts = [
    {
      ...
      description:
        "Sudadera de algodón con efecto vintage y logo retro bordado.",
      price: 78000,
      discountPrice: 62400,
      category: "hoodies-sacos",
      subcategory: "sudaderas",
      images: [
        {
          url: "https://res.cloudinary.com/tu-cloud/image/upload/v1234567890/products/sudadera-vintage-1.jpg",
          isPrimary: true,
        },
        {
          url: "https://res.cloudinary.com/tu-cloud/image/upload/v1234567890/products/sudadera-vintage-2.jpg",
        },
      ],
      sizes: [
        { size: "S", stock: 12 },
    ...
    },
    {
      ...
      description:
        "Short deportivo de secado rápido con bolsillos funcionales.",
      price: 52000,
      category: "deportivos",
      subcategory: "shorts",
      images: [
        {
          url: "https://res.cloudinary.com/tu-cloud/image/upload/v1234567890/products/short-summer-1.jpg",
          isPrimary: true,
        },
        {
          url: "https://res.cloudinary.com/tu-cloud/image/upload/v1234567890/products/short-summer-2.jpg",
        },
      ],
      sizes: [
        { size: "XS", stock: 6 },
    ...
    },
    {
      ...
      description:
        "Gorra snapback con bordado 3D del logo. Visera plana y ajuste perfecto.",
      price: 35000,
      discountPrice: 28000,
      category: "hombre",
      ...
      images: [
        {
          url: "https://res.cloudinary.com/tu-cloud/image/upload/v1234567890/products/gorra-snapback-1.jpg",
          isPrimary: true,
        },
        {
          url: "https://res.cloudinary.com/tu-cloud/image/upload/v1234567890/products/gorra-snapback-2.jpg",
        },
      ],
      sizes: [
        { size: "M", stock: 25 },
...
async function seedDevelopment() {
  try {
    ...
    await Product.updateMany(
      {
        name: {
          $regex: /Hoodie|Camiseta|Set Deportivo|Chaqueta|Gorra/,
          $options: "i",
        },
      },
      { isFeatured: true },
